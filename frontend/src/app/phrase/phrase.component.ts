...
export class PhraseComponent implements OnInit {
    ...
    constructor(private _appService: AppService, private _elementRef: ElementRef, private _renderer: Renderer2) {
    }
    ...
    updateTable() {
        ...
        this._appService.getPhrases(Array.from(this.buttonsClicked.values())).pipe(tap((response) => {
