...
public interface QuestionMapper {
    ...
    default List<String> toView(Question question) {
        List<String> collect = Stream.concat(Stream.concat(question.getWrongAnswers().stream(), question.getCorrectAnswers().stream()), Stream.of(question.getCorrectAnswer())).toList();
